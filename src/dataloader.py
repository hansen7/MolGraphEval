#  Ref: snap-stanford/pretrain-gnns/blob/master/bio/dataloader.py
#  Ref: snap-stanford/pretrain-gnns/blob/master/chem/dataloader.py
...
class DataLoaderSubstructContext(DataLoader):
    ...
    def __init__(self, dataset, batch_size=1, shuffle=True, **kwargs):
        super(DataLoaderSubstructContext, self).__init__(
            ...
            batch_size,
            shuffle,
            collate_fn=lambda l: BatchSubstructContext.from_data_list(l),
            **kwargs
        )
...
class DataLoaderMasking(DataLoader):
    ...
    def __init__(self, dataset, batch_size=1, shuffle=True, **kwargs):
        super(DataLoaderMasking, self).__init__(
            ...
            batch_size,
            shuffle,
            collate_fn=lambda l: BatchMasking.from_data_list(l),
            **kwargs
        )
...
class DataLoaderAE(DataLoader):
    ...
    def __init__(self, dataset, batch_size=1, shuffle=True, **kwargs):
        super(DataLoaderAE, self).__init__(
            ...
            batch_size,
            shuffle,
            collate_fn=lambda l: BatchAE.from_data_list(l),
            **kwargs
        )
