    ...
    for dataset in dataset_list[5:]:
        ...
        legend1 = ax1.legend(
            *scatter.legend_elements(),
            loc=(0.0, 1.02),
            title="Node Degree (Random Init 1)",
            ncol=5
        )
        ...
        legend2 = ax2.legend(
            *scatter.legend_elements(),
            loc=(0.0, 1.02),
            title="Node Degree (Random Init 2)",
            ncol=5
        )
        ...
        legend3 = ax3.legend(
            *scatter.legend_elements(),
            loc=(0.0, 1.02),
            title="Node Degree (Random Init 3)",
            ncol=5
        )
        plt.tight_layout()
        ...
        plt.draw()
        fig.savefig(
            "../figures/tsne_NodeDegree_%s1.png" % dataset,
        ...
        legend1 = ax1.legend(
            *scatter.legend_elements(),
            loc=(0.0, 1.02),
            title="Node Degree (Pre-Trained AM50k)",
            ncol=5
        )
        ...
        legend2 = ax2.legend(
            *scatter.legend_elements(),
            loc=(0.0, 1.02),
            title="Node Degree (Pre-Trained AM100k)",
            ncol=5
        )
        ...
        legend3 = ax3.legend(
            *scatter.legend_elements(),
            loc=(0.0, 1.02),
            title="Node Degree (Pre-Trained AM200k)",
            ncol=5
        )
        plt.tight_layout()
        ...
        plt.draw()
        fig.savefig(
            "../figures/tsne_NodeDegree_%s2.png" % dataset,
            bbox_extra_artists=(legend1, legend2, legend3),
            bbox_inches="tight",
            dpi=200,
        )
        ...
        legend1 = ax1.legend(
            *scatter.legend_elements(),
            loc=(0.0, 1.02),
            title="Node Degree (Pre-Trained IM50k)",
            ncol=5
        )
        ...
        legend2 = ax2.legend(
            *scatter.legend_elements(),
            loc=(0.0, 1.02),
            title="Node Degree (Pre-Trained IM100k)",
            ncol=5
        )
        ...
        legend3 = ax3.legend(
            *scatter.legend_elements(),
            loc=(0.0, 1.02),
            title="Node Degree (Pre-Trained IM200k)",
            ncol=5
        )
        plt.tight_layout()
        plt.draw()
        fig.savefig(
            "../figures/tsne_NodeDegree_%s3.png" % dataset,
            bbox_extra_artists=(legend1, legend2, legend3),
            bbox_inches="tight",
            dpi=200,
        )
        ...
        legend1 = ax1.legend(
            *scatter.legend_elements(),
            loc=(0.0, 1.02),
            title="Node Degree (Pre-Trained GraphCL)",
            ncol=5
        )
        ...
        legend2 = ax2.legend(
            *scatter.legend_elements(),
            loc=(0.0, 1.02),
            title="Node Degree (Pre-Trained JOAO)",
            ncol=5
        )
        ...
        legend3 = ax3.legend(
            *scatter.legend_elements(),
            loc=(0.0, 1.02),
            title="Node Degree (Pre-Trained JOAOv2)",
            ncol=5
        )
        plt.tight_layout()
        plt.draw()
        fig.savefig(
            "../figures/tsne_NodeDegree_%s4.png" % dataset,
            bbox_extra_artists=(legend1, legend2, legend3),
            bbox_inches="tight",
            dpi=200,
        )
