...
class BatchMasking(Data):
    ...
    def from_data_list(data_list):
        ...
        for i, data in enumerate(data_list):
            ...
            # data.keys: ['id', 'edge_attr', 'mask_node_label', 'masked_atom_indices', 'positions', 'z', 'edge_index', 'x', 'mol_id', 'masked_x']
...
class BatchSubstructContext(Data):
    ...
    def from_data_list(data_list):
        ...
        # 'x', 'masked_atom_indices', 'edge_attr',
        # 'KG_index', 'mask_node_label', 'edge_index'
        # keys = [set(data.keys) for data in data_list]
        # keys = list(set.union(*keys))
        # print('keys\t', keys)
