...
# https://raw.githubusercontent.com/BorgwardtLab/WWL/96ed6d3e877b4fdedcd4253079da52f697efaecc/src/wwl/propagation_scheme.py
...
class WeisfeilerLehman(TransformerMixin):
    ...
    def fit_transform(
        self, X: List[ig.Graph], num_iterations: int = 3, return_sequences=True
    ):
...
class ContinuousWeisfeilerLehman(TransformerMixin):
    ...
    def fit_transform(
        self, X: List[ig.Graph], node_features=None, num_iterations: int = 3
    ):
        """
