...
def rdkit_functional_group_label_features_generator(smiles):
    ...
    :param smiles: A molecule (i.e. either a SMILES string or an RDKit obj).
...
class MoleculeDataset_Motif(InMemoryDataset):
    def __init__(
        self,
        root,
        dataset,
        ...
        super(MoleculeDataset_Motif, self).__init__(
        ...
        print(
            "Dataset: {}\nData: {}\nMotif: {}".format(
                self.dataset, self.data, self.motif_label_list.size()
            )
        )
